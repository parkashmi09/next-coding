...
function App() {
  // WhatsApp dummy number - replace with your actual number
  const whatsappNumber = "919876543210"; // Format: country code + number without +
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=Hello%2C%20I%20would%20like%20to%20inquire%20about%20your%20services.`;
